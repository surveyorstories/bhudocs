"use strict";(self.webpackChunkbhukamatha=self.webpackChunkbhukamatha||[]).push([["2615"],{8289:function(e,t,i){i.d(t,{Z:function(){return n}});var r=i(5893),a=i(7294);let n=function(e){let{title:t,initialItems:i}=e,[n,o]=(0,a.useState)(i),[s,c]=(0,a.useState)(0),[l,d]=(0,a.useState)(!1);(0,a.useEffect)(()=>{p()},[n]);let h=e=>{o(n.map(t=>t.id===e?{...t,checked:!t.checked}:t))},p=()=>{let e=n.filter(e=>e.checked).length,t=e/n.length*100;c(t),100===t&&(d(!0),setTimeout(()=>d(!1),5e3))};return(0,r.jsxs)("div",{className:"full-page-container",children:[(0,r.jsx)("style",{children:`
        /* CSS styles */
        body, html {
          margin: 0;
          padding: 0;
